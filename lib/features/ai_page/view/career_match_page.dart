  ...
  Future<void> _submitSkills(List<Skill> selectedSkills) async {
    ...
    try {
      ...
      final response = await http.get(Uri.parse(
          'https://recipe-recommender-w5nk.onrender.com/recommend/?skills=$skillsString'));
      ...
      if (response.statusCode < 300) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) =>
                CareerPathConfirmationPage(careerPath: jobTitle),
          ),
        );
      } else {
              ...
              child: CustomButton(
                ...
                onTap: () {
                  final selectedSkills =
                      skills.where((s) => s.isSelected).toList();
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize:
                              (27 / 932) * ScreenUtils.screenHeight(context),
                          fontWeight: FontWeight.w500,
