...
class QuizOverviewScreen extends StatelessWidget {
                    ...
                    Expanded(
                      child: BarChart(
                        BarChartData(
                          ...
                          groupsSpace:
                              (60 / 430) * ScreenUtils.screenWidth(context),
                        ),
                      ),
                    ),
                  ],
                  ...
                  child: Padding(
                    ...
                    child: Stack(
                      ...
                      children: [
                        SizedBox(
                            width:
                                (62 / 430) * ScreenUtils.screenWidth(context),
                            height:
                                (62 / 430) * ScreenUtils.screenWidth(context),
  ...
  BarChartGroupData _buildBarGroup(
      BuildContext context, int x, double y, Color color) {
