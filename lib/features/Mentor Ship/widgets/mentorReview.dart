    ...
    return Column(
      children: [
        Container(
          ...
          child: Padding(
            padding:
                EdgeInsets.all((8 / 462) * ScreenUtils.screenWidth(context)),
            child: Row(
              children: [
                Image.asset(
                    'assets/images/istockphoto-509286952-612x612 1.png'),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                            width:
                                (4 / 462) * ScreenUtils.screenWidth(context)),
                    ...
                    Row(
                      children: [
                        ...
                        SizedBox(
                            width:
                                (140 / 462) * ScreenUtils.screenWidth(context)),
                        Container(
                          height:
                              (34 / 932) * ScreenUtils.screenHeight(context),
...
class mentorShipList extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> mentorsList = [
    ...
    {'name': 'Ahmed Magdy', 'rate': '3.5', 'track': '-AI', 'people': '9'},
    {'name': 'Tamer Elgayar', 'rate': '3.2', 'track': '-Mobile', 'people': '5'},
    {
      'name': 'Mahmoud Salama',
      'rate': '2.3',
      'track': '-Frontend',
    ...
    {'name': 'TAhmed Magdy', 'rate': '3', 'track': '-Monile', 'people': '11'},
    {'name': 'Peter Parker', 'rate': '3', 'track': '-DevOps', 'people': '12'},
    {'name': 'Bruce Wayne', 'rate': '3', 'track': '-Backend', 'people': '7'},
  ];
