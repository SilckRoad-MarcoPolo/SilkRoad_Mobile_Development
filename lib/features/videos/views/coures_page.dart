  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            UserPicture(
              size: 22,
              width:
                  ScreenUtils.screenHeight(context) * (35 / 462), // Set width
            ...
            children: [
              ...
              Descreption(),
               SizedBox(
                   ...
                   Text(
                    "33 Lessons",
                    style: TextStyle(fontSize:(20 / 932) * ScreenUtils.screenHeight(context) , fontWeight: FontWeight.w800),
                  ),
                    SizedBox(
        ...
        bottomNavigationBar: 
         ...
         Padding(
                   padding: EdgeInsets.only(left: ScreenUtils.screenWidth(context) * (16 / 462),
