              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize:
                            ScreenUtils.screenHeight(context) * (14 / 932)),
                  ),
                ],
              ),
            ),
...
class listOfRewviews extends StatelessWidget {
  ...
  final List<Map<String, String>> listRewviews = [
    {
    ...
    },
    {
      ...
      'rate': '3.8',
      'desc':
          'Super patient and knowledgeable—guided me through my toughest challenges.',
      'time': '3 weeks ago'
    },
    {
      'name': 'Abdelbaset',
    ...
    },
    {
      ...
      'rate': '3.6',
      'desc':
          'Very supportive and always available to help with career guidance.',
      'time': '2 weeks ago'
    },
    {
      'name': 'Adel Shakal',
      'rate': '3.5',
      'desc':
          'A true expert in the field—learned a lot in just a few sessions.',
      'time': '3 weeks ago'
    },
  ];
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ReviewUser(
            reviewsList: listRewviews[index],
          );
        });
  }
}
