      ...
      children: [
        Padding(
          padding: EdgeInsets.only(
              bottom: ScreenUtils.screenHeight(context) * (12 / 932)),
          child: Row(
            children: [
              Icon(
                Icons.facebook,
                color: Color(0xff236AF2),
              ),
              SizedBox(
                width: ScreenUtils.screenWidth(context) * (10 / 462),
              ),
              Text(
                'Facebook ',
                style: TextStyle(
        ...
        Padding(
          padding: EdgeInsets.only(
              bottom: ScreenUtils.screenHeight(context) * (16 / 932)),
          child: Row(
            children: [
              Icon(
                FontAwesomeIcons.linkedin,
                color: Color(0xff003EB4),
              ),
              SizedBox(
                width: ScreenUtils.screenWidth(context) * (10 / 462),
              ),
