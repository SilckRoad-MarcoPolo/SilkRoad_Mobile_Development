...
class AuthApi{
  static String baseUrl ="https://silkroadapis-production.up.railway.app/api/v1";
   ...
   static signUpApi( String firstName, String lastName, String email, String password) async {
      var data = {
  ...
  static sendPasswordResetEmailApi( String email) async {
    ...
    Response response = await Dio().post(
        "$baseUrl/auth/forgotpassword", data: data);
    return response;
  }
  static verifyOtpApi( String otp) async {
   ...
   static confirmNewPasswordApi(String email, String password)
   async {
     var data = {
       'email': email,
       'newPassword': password,
     };
     Response response = await Dio().put("https://silkroadapis-production.up.railway.app/api/v1/auth/resetpassword", data: data);
     return response;
   }
